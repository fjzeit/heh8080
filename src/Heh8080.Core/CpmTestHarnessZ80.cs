...
/// <summary>
/// Minimal CP/M BDOS emulation for running Z80 CPU test suites.
/// </summary>
/// <remarks>
/// Implements:
...
/// </remarks>
public sealed class CpmTestHarnessZ80
{
    ...
    public CpmTestHarnessZ80(Action<char> consoleOutput)
    {
        _memory = new Memory();
        _ioBus = new IoBus();
        _cpu = new CpuZ80(_memory, _ioBus);
